...
The content intelligence layer. Voice-modulated, surface-aware content that speaks in your brand's voice across every touchpoint. Content tokens compiled to match tone, length, and terminology.

### EvidenceKit

The quality proof layer. Structured evidence that what was built is actually on-brand. Not opinion. Traceable verification with pass/fail gates.
